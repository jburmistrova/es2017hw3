#' Julia's Annotation: This code integrates Google Maps and R and gives a distance 
#' Julia's Annotation:     for (i in 1:1:n){ -- this line has a error 
#' Julia's Annotation: This file seems well commented and clear
#' Julia's Annotation: This code could be really useful because Google Maps is easy to use
#' Julia's Annotation:      and has a lot of data/information and is for the entire world
#' Source: https://github.com/rodazuero/gmapsdistance.git
